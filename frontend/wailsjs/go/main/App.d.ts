...
export function ExecuteRequests(
  arg1: Array<Record<string, any>>,
): Promise<string>;

export function ExecuteRequestsWithID(
  arg1: string,
  arg2: Array<Record<string, any>>,
): Promise<string>;

export function ExportSecrets(): Promise<
...
export function GetEnvironments(): Promise<
  Record<string, Record<string, string>>
>;
...
export function LoadFileHistoryFromDir(
  arg1: string,
  arg2: string,
): Promise<string>;
...
export function MigrateResponsesFromRunLocationToHttpFile(
  arg1: string,
  arg2: string,
): Promise<string>;
...
export function RecordScriptLog(
  arg1: string,
  arg2: string,
  arg3: string,
): Promise<void>;
...
export function SaveResponseFileToRunLocation(
  arg1: string,
  arg2: string,
): Promise<string>;
...
export function SendRequestWithID(
  arg1: string,
  arg2: string,
  arg3: string,
  arg4: string,
