...
import {secretvaultlogic} from '../models';
...
export function GetEnterpriseConfig():Promise<secretvaultlogic.EnterpriseConfig>;
...
export function GetMockDemoFile():Promise<app.ExamplesForFirstRunResponse>;

export function GetMockServerStatus():Promise<app.MockServerStatus>;
...
export function OpenEnterpriseConfig():Promise<void>;
...
export function SaveEnterpriseConfig(arg1:secretvaultlogic.EnterpriseConfig):Promise<void>;
...
export function StartMockServer(arg1:string,arg2:string,arg3:number,arg4:string):Promise<void>;

export function StartUpdateAndRestart(arg1:string):Promise<void>;

export function StopMockServer():Promise<void>;

export function TestEnterpriseSecret(arg1:string):Promise<string>;
